...
- 31 Ağustos 2026: Açıklama kolonu kaldırıldı, `budget_items.description` alanı şemadan düşürüldü (migration 20260831120000), kolon seti 12'den 11'e indi. Servis, grid navigasyonu, edit buffers ve iki karar dosyası (BUTCE-EKRAN-KARARLARI.md, BUTCE-UI-MIMARISI.md) buna göre güncellendi.
