...
- KRITIK ACIK: butce UI/servis yok (Dilim 2b+); uyari/anomali motoru yok (kural var, kod yok). butce runtime dilimi kod-tarafini ACAR (cost_object sema CANLI). TECH-DEBT Acik Borc 5/5 SINIRDA — yeni borc oncesi kapatma.
