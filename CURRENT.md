...
- HEAD: cf87558 (10 Eylül 2026). Denetim E gereği kapanış commit'inin EBEVEYNİ yazılır, çünkü bu commit CURRENT.md'ye dokunur ve "son commit" o olur.
...
**MADDE 1: KART VE LİSTE BAĞLANTISININ ÜÇ AÇIK MADDESİ (yeni sohbette ele alınacak, Engin kararı 10 Eylül 2026).** Aynı görevdekilerin listede elle sıralanması · kişisiz satırın komisyon alamadığını söyleyen işaretin bulunmaması · komisyonun tabanının satırda görünmemesi. Üçünün gerekçesi `docs/IS-SIRASI.md` Backlog bölümünde.
