...
- HEAD: 149afe3 (2 Eylül 2026 — TD-37 "kapı boş index'te sessizce geçiyor" kaydı ve DERSLER.md'ye "Boş liste 'temiz' sayılıyor" ders sınıfı eklendi). Denetim E gereği burada CURRENT.md'ye dokunan son commit'in EBEVEYNİ yazar; kapanışta YAZMA ANINDAKİ HEAD yazılır, çünkü kapanış commit'i CURRENT.md'ye dokunur ve "son commit" o olur.
