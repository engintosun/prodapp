...
- Migration 20260901130000'den 20260912120000'e kadar CANLIDA. Build geçer, eslint sıfır hata. Originde tek dal: main.
...
**ŞABLONDA SATIRI OLMAYAN SEKİZ GÖREV ATOMU — KARAR BEKLİYOR.** 1607 Dublör, 1608 Aksiyon Teknisyeni, 3903, 3904, 3916, 3917, 1612 Müzisyen, 3914 Kast Sorumlusu görev atomudur ama çekirdek şablonda karşılıkları yok; bu görevlerden biri listede seçilirse satırın nereden doğacağı bugün belirsiz. `docs/butce/KART-KATALOGU.md` §7.5'te üç yol yazılı (atomlar şablona alınır / blok içi eklemeden gelir / liste satırı doğurur), 3 Eylül 2026'dan beri hiçbiri seçilmedi. Oyuncu kartı kapanmadan dönülecek (Engin, 11 Eylül 2026). Bu bir prompt değil KARAR turu ister.
