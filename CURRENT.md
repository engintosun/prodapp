...
1. **KART 1600 — M3, KARTIN ÇİZİMİ.** M1 (şema: etiket cinsi, ikinci etiket bağı, türetme oranı hanesi) ve M2 (motor: kişi etiketine göre gruplama + iki geçişli türetme, saf fonksiyon, `person-groups.ts`, ekrana BAĞLANMADI) BİTTİ. M3 EKRAN işidir ve tasarımı 3 Eylül 2026 turunda kapandı: özet satırı çizimi, üçgen, karakter/oyuncu adı yerleşimi, komisyon satırının birleşik oran hanesi ve o hanenin klavye durağı (BUTCE-EKRAN-KARARLARI §20 ORANIN YERİ + AD YERLEŞİMİ). Yeni oturumun İLK işi 1600'ü yöneten dosyaları BAŞTAN SONA okumaktır — KART-KATALOGU §7.5, KART-GEREKÇELERİ 1600 bölümü, BUTCE-EKRAN-KARARLARI §20 ve kolon seti bölümü, BUTCE-SEMA-KARARLARI etiket/türetme bölümü, KABUK-KARARLARI 12.1 ve 12.3, BUTCE-UI-MIMARISI, GLOSSARY, RAKIP-ANALIZI-URUN §2.3 — parça okuma yeterli değildir. Neye bağlı: hiçbir şey. Şablon tohumu ve aralık genişlemesi (16xx + 39xx) VERİ yarısıdır, proje açma yolundan sonra gelir.
