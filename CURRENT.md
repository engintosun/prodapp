...
2. BUTCE GIRIS/ACILIS EKRANI dilimi: tarih girisi + SGK senaryo secimi (borclu/kultur — katalogda REFERANS bekliyor) + tesvik yararlanma kosullari bilgilendirmesi + Ocak-varsayimi aciklamasi. Acik maddelerden "Sirket-Profili SGK senaryo SECIMI" ve "soru 5 (parametre paneli yeri)" bu dilimde birlesir. Not: asgari ucret destegi (aylik sabit TL, 2026: 1.270) katalogda YOK — bu dilimde parametre olarak eklenmesi degerlendirilecek.
