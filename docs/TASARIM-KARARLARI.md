...
**SORU PENCERESİ — K3 (25 Eylül 2026, Engin onayı):** Silme soruları tarayıcının kendi kutusuyla değil projenin penceresiyle sorulur (`src/shared/components/use-confirm-sheet.tsx`). Pencere K1 kuralıyla basılan ×'in ya da düğmenin yanında açılır, arka kararmaz; başlığı sorunun kendisidir, altında "Vazgeç" ve kırmızı onay düğmesi durur; onay düğmesi sorunun fiilini taşır ("Sil", dönemde "Kaldır"). Açılınca imleç pencerenin kapatma düğmesinde durur; Enter orada kapatır, Esc de Vazgeç sayılır. Soru olmayan uyarılar (çıkış hatası) pencereyle değil hata mesajıyla gösterilir. Uygulama: K3-2 kalem silme ve dönem kaldırma (25 Eylül 2026); K3-3 Üretim Kayıtları'nda tek ve toplu kişi silme ile çıkış hataları (25 Eylül 2026); K3-4 komisyon sorusu (BUTCE-EKRAN-KARARLARI §20, K3b).
