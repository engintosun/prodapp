...
2. Aidiyet veridir, türetme değil: `budget_items.heading_code` başlığın katalog kodunu tutar (NULL = Başlıksız); `item_library.heading_id` aynı ilkeyle kütüphane tarafında atomun bağlı olduğu başlığı VERİ olarak tutar, koddan türetilmez (BUTCE-SEMA-KARARLARI, REVİZYON maddesi + KART 1600 M2).
