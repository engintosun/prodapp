...
> Devam ediyor. Kilitli karar degil; oneri + acik kararlardir.
...
## Onerilen kart listesi (ust-grup -> kart)
...
## Acik kararlar (yeni chat netlestirecek)
1. Senaryo&Hikaye + Yapimci/Yonetmen -> 2 ayri kart mi tek mi
2. Post -> 4 kart mi tek "Post" mi
3. Efekt&Dublor -> ayri kart mi Teknik altinda mi
4. Master listede isaretleme (S=sablon / X=sil / bos=kutuphane) yapilmadi
5. Kart-basi temel kalem secilmedi; Turkce netlesmedi
...
## Faz 1 bekleyen (kod, bu kalem isi bitince)
fn_open_budget (raftan fotokopi; acik: department_code->department_id + donemsiz muhur budget_stages.is_undated?) - fn_lock_budget - fn_match_receipt -> sonra kart-masasi UI (TD-10 kapanir).
