...
| deptOnayla       | 'acc-pending'      | Dept onay              |
| deptReddet       | 'rejected'         | Dept red               |
| accOnayla        | 'approved'         | Muhasebe kesin onay    |
| accReddet        | 'rejected'         | Muhasebe red           |
| deptKismi        | 'split'            | Dept kısmi onay          |
...
|--------------------------|----------------------------------|
| deptHistory.onaylandi    | deptOnayla, deptOnaylaSecili     |
| deptHistory.reddedildi   | deptReddet, deptReddetSecili     |
