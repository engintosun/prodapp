-- D3c-2 (BUTCE-SEMA-KARARLARI M, D3c bolunme): fn_add_budget_item'a UCUNCU YOL.
-- Kartin MEVCUT serbest kalemi oda listesinden secilince ikinci satir AYNI KODLA doger;
-- misc_code_seq ARTMAZ (K-D mukerrer kuralinin serbest kaleme genellenmis hali).
-- Bu migration YALNIZ fonksiyonu degistirir. Tablo/kolon/kisit/index/RLS DEGISMEZ.
-- budget_items.catalog_code uzerinde tekillik kisiti YOKTUR ve eklenmez - ayni kodun
-- birden fazla satirda bulunmasi bu turun ta kendisidir.
--
