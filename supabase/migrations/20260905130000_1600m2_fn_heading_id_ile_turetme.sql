-- KART 1600 M2 (devam): dogum fonksiyonlari artik heading_code'u
-- split_part(catalog_code,'-',1)+is_group ile TURETMIYOR; onceki gocun
-- (20260905120000) actigi item_library.heading_id VERISINI okuyor. Gerekce:
-- Kast Operasyonu basligi hem 16xx hem 39xx atom tasidigi icin tire-oncesi
-- parcadan turetme bu kartta calismaz. Butun kartlarda ayni motor kullanilir,
-- kart-ozel dal YOK.

-- Taban: 20260904120000 (fn_open_budget) ve 20260830140000 (fn_add_budget_item)
-- icindeki GUNCEL tanimlar, birebir. Imzalar AYNI kaldigi icin drop/grant yok.
-- Tek delta: v_heading hesabinin kaynagi split_part yerine heading_id.
